...
* The original package name 'com.example.ob-spring-security-oauth-github' is invalid and this project uses 'com.example.obspringsecurityoauthgithub' instead.
