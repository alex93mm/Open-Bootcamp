...
import { MailConfig, MailersList, TrapCallback, MailerContract, CompiledMailNode, MailDriverContract, QueueMonitorCallback, MailManagerContract, MessageComposeCallback } from '@ioc:Adonis/Addons/Mail';
...
export declare class MailManager extends Manager<ApplicationContract, MailDriverContract, MailerContract<keyof MailersList>, {
     ...
     */
    protected getDefaultMappingName(): "promotional" | "transactional" | "receipts";
    /**
