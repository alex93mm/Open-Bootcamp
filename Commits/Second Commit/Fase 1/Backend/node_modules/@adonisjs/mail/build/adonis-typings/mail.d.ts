...
declare module '@ioc:Adonis/Addons/Mail' {
     ...
     */
    export type DriverResponseType<Driver> = Driver extends MailDriverContract ? UnwrapPromise<ReturnType<Driver['send']>> : never;
    /**
     * Infers the response type of a mailer
     */
    export type MailerResponseType<Name extends keyof MailersList> = DriverResponseType<MailersList[Name]['implementation']>;
    /**
    ...
    export type PostSentEnvolpeNode = {
        from: string;
        to: string[];
    };
    /**
    ...
    export type MailConfig = {
        ...
        mailers: {
            [P in keyof MailersList]: MailersList[P]['config'];
        };
    };
    /**
    ...
    export interface SesDriverContract extends MailDriverContract {
        send(message: MessageNode, options?: Omit<SES.Types.SendRawEmailRequest, 'RawMessage' | 'Source' | 'Destinations'>): Promise<SesMailResponse>;
    }
    /**
     ...
     */
    export type QueueMonitorCallback = (error?: Error & {
    ...
    export interface MailerContract<Name extends keyof MailersList> {
         ...
         * Send email
         */
        send(callback: MessageComposeCallback, config?: DriverOptionsType<MailersList[Name]['implementation']>): Promise<MailerResponseType<Name>>;
        /**
         * Send email by pushing it to the in-memory queue
         */
        sendLater(callback: MessageComposeCallback, config?: DriverOptionsType<MailersList[Name]['implementation']>): Promise<void>;
        /**
         * Close mailer
         */
        close(): Promise<void>;
     ...
     * Shape of the mailer
     */
    export interface MailManagerContract extends ManagerContract<ApplicationContract, MailDriverContract, MailerContract<keyof MailersList>, {
         ...
         */
        preview(callback: MessageComposeCallback): Promise<SmtpMailResponse & {
            url: string;
            account: {
                user: string;
                pass: string;
    ...
    export interface BaseMailerContract<Mailer extends keyof MailersList> {
         ...
         * Preview email
         */
        preview(): Promise<SmtpMailResponse & {
            url: string;
            account: {
                user: string;
                pass: string;
    ...
    export const BaseMailer: {
        mail: MailManagerContract;
        new <Mailer extends keyof MailersList = keyof MailersList>(...args: any[]): BaseMailerContract<Mailer>;
    };
