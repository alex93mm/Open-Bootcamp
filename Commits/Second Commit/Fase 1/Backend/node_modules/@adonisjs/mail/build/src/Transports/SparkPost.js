...
class SparkPostTransport {
    ...
    async send(mail, callback) {
        ...
        try {
             ...
             */
            const emailBody = await get_stream_1.default(mail.message.createReadStream());
            ...
            const messageId = (((_a = response.body.results) === null || _a === void 0 ? void 0 : _a.id) || mail.message.messageId()).replace(/^<|>$/g, '');
